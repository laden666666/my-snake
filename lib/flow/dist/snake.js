...
var _hasInstance = __webpack_require__(51);
...
exports.equalCell = equalCell;
exports.getCellByDirection = getCellByDirection;
exports.getDirectionByCell = getDirectionByCell;

var _Direction = __webpack_require__(32);
...
var Cell = exports.Cell = function () {
    ...
    ;
    (0, _defineProperty2.default)(Cell, _hasInstance2.default, {
...
function equalCell(cell1, cell2) {
    if (!Cell(cell1)) {
        throw new TypeError('Value of argument "cell1" violates contract.\n\nExpected:\nCell\n\nGot:\n' + _inspect(cell1));
    }

    if (!Cell(cell2)) {
        throw new TypeError('Value of argument "cell2" violates contract.\n\nExpected:\nCell\n\nGot:\n' + _inspect(cell2));
    }
 ...
 * @returns {Cell}
 */
function getCellByDirection(cell, direction) {
    function _ref2(_id2) {
        if (!Cell(_id2)) {
            throw new TypeError('Function "getCellByDirection" return value violates contract.\n\nExpected:\nCell\n\nGot:\n' + _inspect(_id2));
        }
    ...
    if (!Cell(cell)) {
        throw new TypeError('Value of argument "cell" violates contract.\n\nExpected:\nCell\n\nGot:\n' + _inspect(cell));
    }

    if (!(direction instanceof Direction)) {
        throw new TypeError('Value of argument "direction" violates contract.\n\nExpected:\nDirection\n\nGot:\n' + _inspect(direction));
    }

    if (_Direction.Down == direction) {
        return _ref2({ x: cell.x, y: cell.y - 1 });
    } else if (_Direction.Up == direction) {
        return _ref2({ x: cell.x, y: cell.y + 1 });
    } else if (_Direction.Left == direction) {
        return _ref2({ x: cell.x - 1, y: cell.y });
 ...
 */
function getDirectionByCell(cell1, cell2) {
    function _ref3(_id3) {
        if (!(_id3 instanceof Direction)) {
            throw new TypeError('Function "getDirectionByCell" return value violates contract.\n\nExpected:\nDirection\n\nGot:\n' + _inspect(_id3));
        }
    ...
    if (Math.abs(dx) > Math.abs(dy)) {
        if (dx > 0) {
            return _ref3(_Direction.Left);
        } else {
            return _ref3(_Direction.Right);
        }
    } else if (Math.abs(dx) < Math.abs(dy)) {
        if (dy > 0) {
            return _ref3(_Direction.Down);
        } else {
            return _ref3(_Direction.Up);
        }
    } else {
        debugger;
...
exports.Right = exports.Left = exports.Down = exports.Up = exports.Direction = undefined;
...
var Direction = exports.Direction = function () {
    ...
    ;
    (0, _defineProperty2.default)(Direction, _hasInstance2.default, {
        value: function value(input) {
...
if (!Direction(Up)) {
    throw new TypeError("Value of variable \"Up\" violates contract.\n\nExpected:\nDirection\n\nGot:\n" + _inspect(Up));
}

var Down = exports.Down = 1;

if (!Direction(Down)) {
    throw new TypeError("Value of variable \"Down\" violates contract.\n\nExpected:\nDirection\n\nGot:\n" + _inspect(Down));
}

var Left = exports.Left = 1;

if (!Direction(Left)) {
    throw new TypeError("Value of variable \"Left\" violates contract.\n\nExpected:\nDirection\n\nGot:\n" + _inspect(Left));
}
...
if (!Direction(Right)) {
    throw new TypeError("Value of variable \"Right\" violates contract.\n\nExpected:\nDirection\n\nGot:\n" + _inspect(Right));
}

function getReverse(d1) {
    function _ref(_id) {
        if (!Direction(_id)) {
            throw new TypeError("Function \"getReverse\" return value violates contract.\n\nExpected:\nDirection\n\nGot:\n" + _inspect(_id));
        }
    ...
    if (!Direction(d1)) {
        throw new TypeError("Value of argument \"d1\" violates contract.\n\nExpected:\nDirection\n\nGot:\n" + _inspect(d1));
    }
 ...
 * @returns {boolean}
 */
function isReverse(d1, d2) {
    if (!Direction(d1)) {
        throw new TypeError("Value of argument \"d1\" violates contract.\n\nExpected:\nDirection\n\nGot:\n" + _inspect(d1));
    }

    if (!Direction(d2)) {
        throw new TypeError("Value of argument \"d2\" violates contract.\n\nExpected:\nDirection\n\nGot:\n" + _inspect(d2));
    }
...
var Food = exports.Food = function () {
    function Food(input) {
        return input != null && typeof input.grow === 'number' && typeof input.x === 'number' && typeof input.y === 'number';
    }

    ;
    (0, _defineProperty2.default)(Food, _hasInstance2.default, {
        value: function value(input) {
            return Food(input);
        }
    });
...
var _preventExtensions = __webpack_require__(104);
...
var Ground = exports.Ground = function () {
    ...
    (0, _createClass3.default)(Ground, [{
         ...
         * @param cell
         */
        value: function inGround(cell) {
            if (!(cell instanceof _Cell.Cell)) {
                throw new TypeError('Value of argument "cell" violates contract.\n\nExpected:\nCell\n\nGot:\n' + _inspect(cell));
            }
        ...
        key: 'getUsableCells',
        value: function getUsableCells() {
            var _this = this;

            function _ref2(_id2) {
                if (!(Array.isArray(_id2) && _id2.every(function (item) {
                    return item instanceof _Cell.Cell;
                }))) {
            ...
            if (!(Array.isArray(cells) && cells.every(function (item) {
                return item instanceof _Cell.Cell || Array.isArray(item) && item.every(function (item) {
                    return item instanceof _Cell.Cell;
                });
            }))) {
                throw new TypeError('Value of argument "cells" violates contract.\n\nExpected:\nArray<Cell | Array<Cell>>\n\nGot:\n' + _inspect(cells));
            }
            ...
            cells.forEach(function (element) {
                if (!(element instanceof _Cell.Cell || Array.isArray(element) && element.every(function (item) {
                    return item instanceof _Cell.Cell;
                }))) {
            ...
            for (var _y = 0; _y < this.height; _y++) {
                for (var _x = 0; _x < this.width; _x++) {
                    if (!_cells[_y][_x]) {
                        usableCellList.push({ x: _x, y: _y });
                    }
                }
            }
            return _ref2(usableCellList);
        }
        ...
        value: function getRandomUsableCells(count) {
            function _ref3(_id3) {
            ...
            return _ref3((0, _util.randomChoose)(usableCellList, count));
        }
    }]);
    return Ground;
}();
...
var _Snake = __webpack_require__(121);

var _Ground = __webpack_require__(69);
...
var _Print = __webpack_require__(150);
...
var Game = exports.Game = function () {
    ...
    function Game(options) {
        ...
        if (!(options != null && (options.width === undefined || typeof options.width === 'number') && (options.height === undefined || typeof options.height === 'number') && (options.headerPosition === undefined || options.headerPosition instanceof _Cell.Cell) && (options.direction === undefined || options.direction instanceof _Direction.Direction) && (options.bodyLength === undefined || typeof options.bodyLength === 'number'))) {
            throw new TypeError("Value of argument \"options\" violates contract.\n\nExpected:\n{\n  width?: number;\n  height?: number;\n  headerPosition?: Cell;\n  direction?: Direction;\n  bodyLength?: number;\n}\n\nGot:\n" + _inspect(options));
        }

        var width = options.width;

        var _width$height$bodyLen = (0, _extends3.default)({
            width: 10,
            height: 10,
            bodyLength: 3
        }, options),
            width = _width$height$bodyLen.width,
            height = _width$height$bodyLen.height,
            headerPosition = _width$height$bodyLen.headerPosition,
            direction = _width$height$bodyLen.direction,
            bodyLength = _width$height$bodyLen.bodyLength;
    ...
    (0, _createClass3.default)(Game, [{
        ...
        value: function frame() {
            ...
            if (eatFood) {
                ...
                if (!(Array.isArray(this.$food) && this.$food.every(function (item) {
                    return item instanceof _Food.Food;
                }))) {
                    throw new TypeError("Value of \"this.$food\" violates contract.\n\nExpected:\nArray<Food>\n\nGot:\n" + _inspect(this.$food));
                }
        ...
        key: "turn",
        value: function turn(willTurnDirection) {
            if (!(willTurnDirection instanceof _Direction.Direction)) {
                throw new TypeError("Value of argument \"willTurnDirection\" violates contract.\n\nExpected:\nDirection\n\nGot:\n" + _inspect(willTurnDirection));
            }
        ...
        value: function $createFood() {
            ...
            cells.forEach(function (cell) {
                _this.$food.push((0, _extends3.default)({}, cell, { grow: Math.floor(Math.random() * 3) + 1 }));
            });
        }
    }]);
    return Game;
...
$export($export.S + $export.F * !__webpack_require__(8), 'Object', { defineProperties: __webpack_require__(59) });
...
var Snake = exports.Snake = function () {
    (0, _createClass3.default)(Snake, [{
        ...
        get: function get() {
            ...
            return _ref((0, _extends3.default)({}, this.$header));
        }
        ...
        get: function get() {
            ...
            return _ref2(this.$body.map(function (item) {
    ...
    function Snake(options) {
        ...
        if (!(options != null && options.headerPosition instanceof _Cell.Cell && (options.direction === undefined || options.direction instanceof _Direction.Direction) && (options.bodyLength === undefined || typeof options.bodyLength === 'number'))) {
            throw new TypeError('Value of argument "options" violates contract.\n\nExpected:\n{\n  headerPosition: Cell;\n  direction?: Direction;\n  bodyLength?: number;\n}\n\nGot:\n' + _inspect(options));
        }
        ...
        if (!(this.$header instanceof _Cell.Cell)) {
            throw new TypeError('Value of "this.$header" violates contract.\n\nExpected:\nCell\n\nGot:\n' + _inspect(this.$header));
        }

        this.$body = [];

        if (!(Array.isArray(this.$body) && this.$body.every(function (item) {
            return item instanceof _Cell.Cell;
        }))) {
            throw new TypeError('Value of "this.$body" violates contract.\n\nExpected:\nCell[]\n\nGot:\n' + _inspect(this.$body));
        }

        var lastBody = this.$header;
        for (var i = 0; i < options.bodyLength; i++) {
            lastBody = (0, _Cell.getCellByDirection)(lastBody, DirectionTools.getReverse(this.$direction));
    ...
    (0, _createClass3.default)(Snake, [{
        ...
        value: function move(food) {
            ...
            if (!(Array.isArray(food) && food.every(function (item) {
                return item instanceof _Food.Food;
            }) || food instanceof _Food.Food)) {
                throw new TypeError('Value of argument "food" violates contract.\n\nExpected:\nFood[] | Food\n\nGot:\n' + _inspect(food));
            }
        ...
        value: function $move() {
            ...
            if (this.$growAmount > 0) {
                ...
                this.$header = (0, _Cell.getCellByDirection)(this.$header, this.$direction);
        ...
        key: 'canEat',
        value: function canEat(food) {
            function _ref6(_id6) {
                if (!(_id6 instanceof _Food.Food)) {
                    throw new TypeError('Function return value violates contract.\n\nExpected:\nFood\n\nGot:\n' + _inspect(_id6));
                }
            ...
            if (!(Array.isArray(_food) && _food.every(function (item) {
                return item instanceof _Food.Food;
            }))) {
                throw new TypeError('Value of variable "_food" violates contract.\n\nExpected:\nFood[]\n\nGot:\n' + _inspect(_food));
            }
            ...
            var nextHeader = (0, _Cell.getCellByDirection)(this.$header, this.$direction);

            return _ref6(_food.filter(function (item) {
                return (0, _Cell.equalCell)(item, nextHeader);
            })[0] || null);
        }
        ...
        value: function eat(food) {
            if (!(food instanceof _Food.Food)) {
                throw new TypeError('Value of argument "food" violates contract.\n\nExpected:\nFood\n\nGot:\n' + _inspect(food));
            }

            this.$growAmount += food.grow;

            if (!(typeof this.$growAmount === 'number')) {
                throw new TypeError('Value of "this.$growAmount" violates contract.\n\nExpected:\nnumber\n\nGot:\n' + _inspect(this.$growAmount));
            }
        ...
        value: function isDead() {
            ...
            return this.$body.every(function (item) {
                return !(0, _Cell.equalCell)(_this.$header, item);
            });
        }
    }]);
    return Snake;
...
module.exports = __webpack_require__(28).f('hasInstance');
    ...
    return _regenerator2.default.wrap(function _random$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    makeRandom = function makeRandom(_seed) {
                        function _ref(_id) {
                            if (!(typeof _id === 'number')) {
                                throw new TypeError("Function \"makeRandom\" return value violates contract.\n\nExpected:\nnumber\n\nGot:\n" + _inspect(_id));
                            }
                        ...
                        if (!(typeof _seed === 'number')) {
                            throw new TypeError("Value of argument \"_seed\" violates contract.\n\nExpected:\nnumber\n\nGot:\n" + _inspect(_seed));
                        }

                        _seed = (_seed * 9301 + 49297) % 233280; //为何使用这三个数?
                        return _ref(_seed / 233280.0);
                    };
                    ...
                    throw new TypeError("Value of argument \"seed\" violates contract.\n\nExpected:\nnumber\n\nGot:\n" + _inspect(seed));
...
var random = exports.random = function random(seed) {
    if (!(typeof seed === 'number')) {
        throw new TypeError("Value of argument \"seed\" violates contract.\n\nExpected:\nnumber\n\nGot:\n" + _inspect(seed));
    }
...
* @returns
*/
var randomChoose = exports.randomChoose = function randomChoose(list, chooseNum) {
    var seed = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : Date.now();
    ...
    if (!(typeof chooseNum === 'number')) {
        throw new TypeError("Value of argument \"chooseNum\" violates contract.\n\nExpected:\nnumber\n\nGot:\n" + _inspect(chooseNum));
    }
    ...
    return _ref2(randomArr.map(function (i) {
        return list[i];
    }));
};
...
var _Ground2 = __webpack_require__(69);
...
var Print = exports.Print = function (_Ground) {
    ...
    (0, _createClass3.default)(Print, [{
        ...
        get: function get() {
            ...
            return _ref(this.$cells.map(function (row) {
    ...
    (0, _createClass3.default)(Print, [{
        key: '$printCell',
        value: function $printCell(cell, cellShowType) {
            if (!(cell instanceof _Cell.Cell)) {
                throw new TypeError('Value of argument "cell" violates contract.\n\nExpected:\nCell\n\nGot:\n' + _inspect(cell));
            }

            if (!(cellShowType instanceof CellShowType)) {
                throw new TypeError('Value of argument "cellShowType" violates contract.\n\nExpected:\nCellShowType\n\nGot:\n' + _inspect(cellShowType));
            }
        ...
        key: 'printHead',
        value: function printHead(head, direction) {
            if (!(head instanceof _Cell.Cell)) {
                throw new TypeError('Value of argument "head" violates contract.\n\nExpected:\nCell\n\nGot:\n' + _inspect(head));
            }

            if (!(direction instanceof _Direction.Direction)) {
                throw new TypeError('Value of argument "direction" violates contract.\n\nExpected:\nDirection\n\nGot:\n' + _inspect(direction));
            }
        ...
        key: 'printBody',
        value: function printBody(head, body) {
            if (!(head instanceof _Cell.Cell)) {
                throw new TypeError('Value of argument "head" violates contract.\n\nExpected:\nCell\n\nGot:\n' + _inspect(head));
            }

            if (!(Array.isArray(body) && body.every(function (item) {
                return item instanceof _Cell.Cell;
            }))) {
                throw new TypeError('Value of argument "body" violates contract.\n\nExpected:\nArray<Cell>\n\nGot:\n' + _inspect(body));
            }
            ...
            for (var i = 0, lastCell = head; i < body.length; i++) {
                ...
                if (i == body.length - 1) {
                    cellShowType = CellShowType['TAIL_' + this.$getDirectionString((0, _Cell.getDirectionByCell)(body[i], lastCell))];
                    this.$printCell(body[i], cellShowType);
                    break;
                } else {
                    var nextCell = body[i + 1];
                    var turningDirection = (0, _Cell.getDirectionByCell)(body[i], lastCell);
                    var nextTurningDirection = (0, _Cell.getDirectionByCell)(body[i], nextCell);
                    if (turningDirection == nextTurningDirection || (0, _Direction.isReverse)(turningDirection, nextTurningDirection)) {
