...
var _Direction = __webpack_require__(20);
...
var Ground = exports.Ground = function () {
    ...
    (0, _createClass3.default)(Ground, [{
        ...
        value: function getUsableCells() {
            ...
            for (var _y = 0; _y < this.height; _y++) {
                for (var _x3 = 0; _x3 < this.width; _x3++) {
                    if (!_cells[_y][_x3]) {
                        usableCellList.push({ x: _x3, y: _y });
                    }
                }
            }
        ...
        value: function getRandomUsableCells(count) {
            ...
            var usableCellList = this.getUsableCells.apply(this, (0, _toConsumableArray3.default)(cells));
...
var _Snake = __webpack_require__(76);

var _Ground = __webpack_require__(47);

var _Direction = __webpack_require__(20);

var _Print = __webpack_require__(81);
...
var Game = exports.Game = function () {
    ...
    (0, _createClass3.default)(Game, [{
        ...
        value: function $createFood() {
            ...
            var cells = this.$ground.getRandomUsableCells(count, this.$food.map(function (foot) {
                return foot;
            }), this.$snake.header, this.$snake.body);
            cells.forEach(function (cell) {
                _this2.$food.push((0, _extends3.default)({}, cell, { grow: Math.floor(Math.random() * 3) + 1 }));
            });
        }
    }]);
    return Game;
...
var Snake = exports.Snake = function () {
    (0, _createClass3.default)(Snake, [{
        key: 'header',
        get: function get() {
            return (0, _extends3.default)({}, this.$header);
        }
     ...
     * @param options.headerPosition     初始头部坐标
     */
    function Snake(_options) {
        (0, _classCallCheck3.default)(this, Snake);
        this.$direction = _Direction.Down;
        this.$growAmount = 0;
        this.defaultOption = {
            direction: _Direction.Up,
            bodyLength: 3 };
        ...
        var options = (0, _extends3.default)({}, _options, this.defaultOption);
        ...
        for (var i = 0; i < options.bodyLength; i++) {
            lastBody = (0, _Cell.getCellByDirection)(lastBody, (0, _Direction.getReverse)(this.$direction));
    ...
    (0, _createClass3.default)(Snake, [{
        ...
        value: function turn(willTurnDirection) {
            ...
            if (!(0, _Direction.isReverse)(willTurnDirection, this.$direction)) {
...
var _Ground2 = __webpack_require__(47);
    ...
    function Print() {
        ...
        for (var y = 0; y < _this.height; y++) {
            ...
            for (var x = 0; x < _this.width; x++) {
                _this.$cells[y][x] = countries.BLANK;
            }
        }
        return _this;
    }
    ...
    (0, _createClass3.default)(Print, [{
        ...
        value: function printBody(head, body) {
            ...
            for (var i = 0, lastCell = head; i < body.length; i++) {
                ...
                if (i == body.length - 1) {
                    cellShowType = countries['TAIL_' + this.$getDirectionString((0, _Cell.getDirectionByCell)(body[i], lastCell))];
                    ...
                    if (turningDirection == nextTurningDirection || (0, _Direction.isReverse)(turningDirection, nextTurningDirection)) {
                        ...
                        cellShowType = countries['BODY_' + this.$getDirectionString(turningDirection) + '_TURNING_' + this.$getDirectionString(nextTurningDirection)];
                    }
                    this.$printCell(body[i], cellShowType);
                    lastCell = body[i];
                }
        ...
        value: function printFoot(food) {
            ...
            food.forEach(function (f) {
                if (f.grow == 1) {
                    _this2.$printCell(f, countries.FOOD_1);
                } else if (f.grow == 2) {
                    _this2.$printCell(f, countries.FOOD_2);
                } else if (f.grow == 3) {
                    _this2.$printCell(f, countries.FOOD_3);
                }
            });
        }
    }]);
