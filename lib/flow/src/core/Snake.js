    ...
    */
    ...
    constructor(_options: {
        ...
        for(let i = 0; i < options.bodyLength; i++){
            lastBody = getCellByDirection(lastBody, getReverse(this.$direction));
    ...
    turn(willTurnDirection: Direction){
        ...
        if(!isReverse(willTurnDirection, this.$direction) ){
     ...
     * @memberof Snake
     */
    canEat(food: Food[]|Food): Food | null{
        let _food: Food[] = [];
