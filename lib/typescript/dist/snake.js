...
Object.defineProperty(exports, "__esModule", { value: true });
var Direction_1 = __webpack_require__(15);
...
var ReadOnlyCell = function (_Cell) {
    (0, _inherits3.default)(ReadOnlyCell, _Cell);

    function ReadOnlyCell(x, y) {
        (0, _classCallCheck3.default)(this, ReadOnlyCell);
        return (0, _possibleConstructorReturn3.default)(this, (ReadOnlyCell.__proto__ || (0, _getPrototypeOf2.default)(ReadOnlyCell)).call(this, x, y));
    }

    (0, _createClass3.default)(ReadOnlyCell, null, [{
        key: "clone",
        value: function clone(cell) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var Cell_1 = __webpack_require__(16);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Snake_1 = __webpack_require__(55);
var Ground_1 = __webpack_require__(48);
var Direction_1 = __webpack_require__(15);
var Food_1 = __webpack_require__(95);
var Print_1 = __webpack_require__(96);
...
var Game = function () {
    ...
    (0, _createClass3.default)(Game, [{
        ...
        value: function check() {
            ...
            var snakeCell = [].concat((0, _toConsumableArray3.default)(this.$snake.body), [this.$snake.header]);
            var snakeCellMap = {};
            return {
                result: [].concat((0, _toConsumableArray3.default)(this.$snake.body), [this.$snake.header]).every(function (cell) {
                    if (snakeCellMap[cell.x + ':' + cell.y] || !_this.$ground.inGround(cell)) {
                        return false;
                    } else {
        ...
        value: function $createFood() {
            ...
            cells.forEach(function (cell) {
                _this2.$food.push(new Food_1.Food(cell.x, cell.y, Math.floor(Math.random() * 3) + 1));
            });
        }
    }]);
    return Game;
...
var Food = function (_Cell_1$Cell) {
    (0, _inherits3.default)(Food, _Cell_1$Cell);
...
})(CellShowType = exports.CellShowType || (exports.CellShowType = {}));

var Print = function (_Ground_1$Ground) {
    (0, _inherits3.default)(Print, _Ground_1$Ground);
