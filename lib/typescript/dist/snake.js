...
var DirectionTools = function () {
    function DirectionTools() {
        _classCallCheck(this, DirectionTools);
    }
    /**
     * 获取一个方向的反方向
     * @param d1
    ...
    _createClass(DirectionTools, null, [{
        key: "getReverse",
        value: function getReverse(d1) {
            if (d1 == Direction.Up) {
        ...
        key: "isReverse",
        value: function isReverse(d1, d2) {
        ...
        key: "isSyntropy",
        value: function isSyntropy(d1, d2) {
            if (d1 == Direction.Up && d2 == Direction.Down || d1 == Direction.Right && d2 == Direction.Left || d1 == Direction.Down && d2 == Direction.Up || d1 == Direction.Left && d2 == Direction.Right) {
                return true;
            }
            return false;
        }
...
exports.DirectionTools = DirectionTools;
...
Object.defineProperty(exports, "__esModule", { value: true });
var Direction_1 = __webpack_require__(63);
...
var Cell = function () {
    ...
    _createClass(Cell, null, [{
        key: "equal",
        value: function equal(cell1, cell2) {
        ...
        value: function getCellByDirection(cell, direction) {
            if (Direction_1.Direction.Down == direction) {
                return new Cell(cell.x, cell.y - 1);
            } else if (Direction_1.Direction.Up == direction) {
                return new Cell(cell.x, cell.y + 1);
            } else if (Direction_1.Direction.Left == direction) {
                return new Cell(cell.x - 1, cell.y);
            } else if (Direction_1.Direction.Right == direction) {
                return new Cell(cell.x + 1, cell.y);
            }
        }
        /**
        ...
        value: function getDirectionByCell(cell1, cell2) {
...
var ReadOnlyCell = function (_Cell) {
    _inherits(ReadOnlyCell, _Cell);

    function ReadOnlyCell(x, y) {
        _classCallCheck(this, ReadOnlyCell);

        return _possibleConstructorReturn(this, (ReadOnlyCell.__proto__ || Object.getPrototypeOf(ReadOnlyCell)).call(this, x, y));
    }

    _createClass(ReadOnlyCell, null, [{
        key: "clone",
        value: function clone(cell) {
...
var Ground = function () {
    ...
    _createClass(Ground, [{
        ...
        value: function getUsableCells() {
            ...
            for (var _y = 0; _y < this.height; _y++) {
                for (var _x3 = 0; _x3 < this.width; _x3++) {
                    if (!_cells[_y][_x3]) {
                        usableCellList.push(new Cell_1.Cell(_x3, _y));
                    }
                }
            }
        ...
        value: function getRandomUsableCells(count) {
            ...
            return util_1.randomChoose(usableCellList, count);
        }
    }]);
...
var Game_1 = __webpack_require__(331);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Snake_1 = __webpack_require__(332);
var Ground_1 = __webpack_require__(127);
var Direction_1 = __webpack_require__(63);
var Food_1 = __webpack_require__(334);
var Print_1 = __webpack_require__(335);
...
var Game = function () {
    function Game(_ref) {
        ...
        //创建贪食蛇的坐标系
        this.$ground = new Ground_1.Ground(width, height);
        //创建绘制对象
        this.$print = new Print_1.Print(width, height);
        //创建食物
        this.$createFood(3);
    }
    /**
    ...
    _createClass(Game, [{
        ...
        value: function $createFood() {
            ...
            cells.forEach(function (cell) {
                _this.$food.push(new Food_1.Food(cell.x, cell.y, Math.floor(Math.random() * 3) + 1));
            });
        }
    }]);
...
var Snake = function () {
    ...
    function Snake(options) {
        ...
        */
        ...
        this.$header = new Cell_1.Cell(options.headerPosition.x, options.headerPosition.y);
        //生成身体
        this.$body = [];
        var lastBody = this.$header;
        for (var i = 0; i < options.bodyLength; i++) {
            lastBody = Cell_1.Cell.getCellByDirection(lastBody, Direction_1.DirectionTools.getReverse(this.$direction));
    ...
    _createClass(Snake, [{
        ...
        value: function $move() {
            ...
            if (this.$growAmount > 0) {
                ...
                this.$header = Cell_1.Cell.getCellByDirection(this.$header, this.$direction);
                this.$growAmount--;
            } else {
                this.$body.unshift(this.$header);
                this.$body.pop();
        ...
        value: function turn(willTurnDirection) {
            ...
            if (!Direction_1.DirectionTools.isReverse(willTurnDirection, this.$direction)) {
        ...
        value: function canEat(food) {
            ...
            var nextHeader = Cell_1.Cell.getCellByDirection(this.$header, this.$direction);
            return _food.filter(function (item) {
                return Cell_1.Cell.equal(item, nextHeader);
            })[0] || null;
        }
        /**
         * 吃食物
        ...
        value: function isDead() {
            ...
            return this.$body.every(function (item) {
                return !Cell_1.Cell.equal(_this.$header, item);
            });
        }
    }, {
        key: "header",
        get: function get() {
            return Cell_1.ReadOnlyCell.clone(this.$header);
        }
    }, {
        key: "body",
        get: function get() {
            return this.$body.map(function (item) {
                return Cell_1.ReadOnlyCell.clone(item);
            });
        }
    }, {
        key: "direction",
...
var _marked = /*#__PURE__*/regeneratorRuntime.mark(_random);
...
function _random(seed) {
    var makeRandom;
    return regeneratorRuntime.wrap(function _random$(_context) {
        while (1) {
...
* @returns
*/
exports.randomChoose = function (list, chooseNum) {
    ...
    var randomListFn = exports.random(seed);
...
var Food = function (_Cell_1$Cell) {
    _inherits(Food, _Cell_1$Cell);
    ...
    function Food(x, y, grow) {
        _classCallCheck(this, Food);

        var _this = _possibleConstructorReturn(this, (Food.__proto__ || Object.getPrototypeOf(Food)).call(this, x, y));
 ...
 */
var CellShowType;
(function (CellShowType) {
    //空白
    CellShowType["BLANK"] = "00";
    //头
    CellShowType["HEAD_UP"] = "01";
    CellShowType["HEAD_DOWN"] = "02";
    CellShowType["HEAD_LEFT"] = "03";
    CellShowType["HEAD_RIGHT"] = "04";
    //直行的身子
    CellShowType["BODY_UP"] = "11";
    CellShowType["BODY_DOWN"] = "12";
    CellShowType["BODY_LEFT"] = "13";
    CellShowType["BODY_RIGHT"] = "14";
    //正在转弯的身子
    CellShowType["BODY_LEFT_TURNING_UP"] = "21";
    CellShowType["BODY_LEFT_TURNING_DOWN"] = "22";
    CellShowType["BODY_RIGHT_TURNING_UP"] = "23";
    CellShowType["BODY_RIGHT_TURNING_DOWN"] = "24";
    CellShowType["BODY_UP_TURNING_LEFT"] = "25";
    CellShowType["BODY_UP_TURNING_RIGHT"] = "26";
    CellShowType["BODY_DOWN_TURNING_LEFT"] = "27";
    CellShowType["BODY_DOWN_TURNING_RIGHT"] = "28";
    //尾巴
    CellShowType["TAIL_UP"] = "31";
    CellShowType["TAIL_DOWN"] = "32";
    CellShowType["TAIL_LEFT"] = "33";
    CellShowType["TAIL_RIGHT"] = "34";
    //食物
    CellShowType["FOOD_1"] = "51";
    CellShowType["FOOD_2"] = "52";
    CellShowType["FOOD_3"] = "53";
})(CellShowType || (CellShowType = {}));

var Print = function (_Ground_1$Ground) {
    _inherits(Print, _Ground_1$Ground);
    ...
    function Print() {
        ...
        var _this = _possibleConstructorReturn(this, (Print.__proto__ || Object.getPrototypeOf(Print)).call(this, width, height));
    ...
    _createClass(Print, [{
        ...
        value: function printBody(head, body) {
            ...
            for (var i = 0, lastCell = head; i < body.length; i++) {
                ...
                if (i == body.length - 1) {
                    cellShowType = CellShowType['TAIL_' + this.$getDirectionString(Cell_1.Cell.getDirectionByCell(body[i], lastCell))];
                    this.$printCell(body[i], cellShowType);
                    break;
                } else {
                    var nextCell = body[i + 1];
                    var turningDirection = Cell_1.Cell.getDirectionByCell(body[i], lastCell);
                    var nextTurningDirection = Cell_1.Cell.getDirectionByCell(body[i], nextCell);
                    if (turningDirection == nextTurningDirection || Direction_1.DirectionTools.isReverse(turningDirection, nextTurningDirection)) {
